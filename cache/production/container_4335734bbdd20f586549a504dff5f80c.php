...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005ca8c18f000000003203c778(
...
class phpbbtemplatetwiglexer_000000005ca8c18f000000003203c778 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5af246a963024029299136 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5af246a963031675562344 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5af246a962fff498799603 = array(
    ...
    {
        $this->initializer5af246a963031675562344 && ($this->initializer5af246a963031675562344->__invoke($valueHolder5af246a963024029299136, $this, 'set_environment', array('env' => $env), $this->initializer5af246a963031675562344) || 1) && $this->valueHolder5af246a963024029299136 = $valueHolder5af246a963024029299136;

        return $this->valueHolder5af246a963024029299136->set_environment($env);
    }
    ...
    {
        $this->initializer5af246a963031675562344 && ($this->initializer5af246a963031675562344->__invoke($valueHolder5af246a963024029299136, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5af246a963031675562344) || 1) && $this->valueHolder5af246a963024029299136 = $valueHolder5af246a963024029299136;

        return $this->valueHolder5af246a963024029299136->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5af246a963031675562344 && ($this->initializer5af246a963031675562344->__invoke($valueHolder5af246a963024029299136, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5af246a963031675562344) || 1) && $this->valueHolder5af246a963024029299136 = $valueHolder5af246a963024029299136;

        return $this->valueHolder5af246a963024029299136->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5af246a963031675562344 = $initializer;
    }
    ...
    {
        $this->initializer5af246a963031675562344 && ($this->initializer5af246a963031675562344->__invoke($valueHolder5af246a963024029299136, $this, '__get', array('name' => $name), $this->initializer5af246a963031675562344) || 1) && $this->valueHolder5af246a963024029299136 = $valueHolder5af246a963024029299136;

        if (isset(self::$publicProperties5af246a962fff498799603[$name])) {
            return $this->valueHolder5af246a963024029299136->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5af246a963024029299136;
    ...
    {
        $this->initializer5af246a963031675562344 && ($this->initializer5af246a963031675562344->__invoke($valueHolder5af246a963024029299136, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5af246a963031675562344) || 1) && $this->valueHolder5af246a963024029299136 = $valueHolder5af246a963024029299136;
    ...
    {
        $this->initializer5af246a963031675562344 && ($this->initializer5af246a963031675562344->__invoke($valueHolder5af246a963024029299136, $this, '__isset', array('name' => $name), $this->initializer5af246a963031675562344) || 1) && $this->valueHolder5af246a963024029299136 = $valueHolder5af246a963024029299136;
    ...
    {
        $this->initializer5af246a963031675562344 && ($this->initializer5af246a963031675562344->__invoke($valueHolder5af246a963024029299136, $this, '__unset', array('name' => $name), $this->initializer5af246a963031675562344) || 1) && $this->valueHolder5af246a963024029299136 = $valueHolder5af246a963024029299136;
    ...
    {
        $this->initializer5af246a963031675562344 && ($this->initializer5af246a963031675562344->__invoke($valueHolder5af246a963024029299136, $this, '__clone', array(), $this->initializer5af246a963031675562344) || 1) && $this->valueHolder5af246a963024029299136 = $valueHolder5af246a963024029299136;

        $this->valueHolder5af246a963024029299136 = clone $this->valueHolder5af246a963024029299136;
    }

    public function __sleep()
    {
        $this->initializer5af246a963031675562344 && ($this->initializer5af246a963031675562344->__invoke($valueHolder5af246a963024029299136, $this, '__sleep', array(), $this->initializer5af246a963031675562344) || 1) && $this->valueHolder5af246a963024029299136 = $valueHolder5af246a963024029299136;

        return array('valueHolder5af246a963024029299136');
    }
    ...
    {
        return $this->initializer5af246a963031675562344;
    }
    ...
    {
        return $this->initializer5af246a963031675562344 && ($this->initializer5af246a963031675562344->__invoke($valueHolder5af246a963024029299136, $this, 'initializeProxy', array(), $this->initializer5af246a963031675562344) || 1) && $this->valueHolder5af246a963024029299136 = $valueHolder5af246a963024029299136;
    }
    ...
    {
        return null !== $this->valueHolder5af246a963024029299136;
    }
    ...
    {
        return $this->valueHolder5af246a963024029299136;
    }
