...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'log' => 'getLogService',
            'lotusjeff.dynamic.listener' => 'getLotusjeff_Dynamic_ListenerService',
            ...
            'rmcgirr83.hidebots.listener' => 'getRmcgirr83_Hidebots_ListenerService',
            ...
            's9e.mediaembed.listener' => 'getS9e_Mediaembed_ListenerService',
    ...
    /**
     * Gets the public 'bb3mobi.lastpostavatar.listener' shared service.
     *
     * @return \bb3mobi\lastpostavatar\event\listener
     */
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('lotusjeff.dynamic.listener', 'lotusjeff\\dynamic\\event\\listener');
        ...
        $instance->addSubscriberService('planetstyles.flightdeck.listener', 'planetstyles\\flightdeck\\event\\listener');
        $instance->addSubscriberService('rmcgirr83.hidebots.listener', 'rmcgirr83\\hidebots\\event\\listener');
        $instance->addSubscriberService('s9e.mediaembed.listener', 's9e\\mediaembed\\listener');
    ...
    {
        $instance = new \gfksx\ThanksForPosts\notification\thanks_remove($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb_user_notifications');
    ...
    {
        $this->services['gothick.recaptcha2.captcha.recaptcha2'] = $instance = new \gothick\recaptcha2\captcha\recaptcha2($this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('request'), $this->get('template'), $this->get('log'), './../', 'php');
    ...
    /**
     * Gets the public 'lotusjeff.dynamic.listener' shared service.
     *
     * @return \lotusjeff\dynamic\event\listener
     */
    protected function getLotusjeff_Dynamic_ListenerService()
    {
        return $this->services['lotusjeff.dynamic.listener'] = new \lotusjeff\dynamic\event\listener($this->get('config'), $this->get('template'), $this->get('user'));
    }
    ...
    /**
     * Gets the public 'phpbb.boardannouncements.controller' shared service.
     *
    ...
    /**
     * Gets the public 'phpbb.boardannouncements.listener' shared service.
     *
    ...
    /**
     * Gets the public 'planetstyles.flightdeck.listener' shared service.
     *
     * @return \planetstyles\flightdeck\event\listener
     */
    protected function getPlanetstyles_Flightdeck_ListenerService()
    {
        return $this->services['planetstyles.flightdeck.listener'] = new \planetstyles\flightdeck\event\listener($this->get('cache.driver'), $this->get('config'), $this->get('config_text'), $this->get('template'));
    }
    ...
    /**
     * Gets the public 'rmcgirr83.hidebots.listener' shared service.
     *
     * @return \rmcgirr83\hidebots\event\listener
     */
    protected function getRmcgirr83_Hidebots_ListenerService()
    {
        return $this->services['rmcgirr83.hidebots.listener'] = new \rmcgirr83\hidebots\event\listener($this->get('auth'), $this->get('config'), $this->get('user'));
    }
    ...
    /**
     * Gets the public 's9e.mediaembed.listener' shared service.
     *
     * @return \s9e\mediaembed\listener
     */
    protected function getS9e_Mediaembed_ListenerService()
    {
        return $this->services['s9e.mediaembed.listener'] = new \s9e\mediaembed\listener();
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005446b9590000000054df1c9e(
...
class phpbbtemplatetwiglexer_000000005446b9590000000054df1c9e extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5af246b6c86f2296584415 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5af246b6c86ff340410224 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5af246b6c86cb059529957 = array(
    ...
    {
        $this->initializer5af246b6c86ff340410224 && ($this->initializer5af246b6c86ff340410224->__invoke($valueHolder5af246b6c86f2296584415, $this, 'set_environment', array('env' => $env), $this->initializer5af246b6c86ff340410224) || 1) && $this->valueHolder5af246b6c86f2296584415 = $valueHolder5af246b6c86f2296584415;

        return $this->valueHolder5af246b6c86f2296584415->set_environment($env);
    }
    ...
    {
        $this->initializer5af246b6c86ff340410224 && ($this->initializer5af246b6c86ff340410224->__invoke($valueHolder5af246b6c86f2296584415, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5af246b6c86ff340410224) || 1) && $this->valueHolder5af246b6c86f2296584415 = $valueHolder5af246b6c86f2296584415;

        return $this->valueHolder5af246b6c86f2296584415->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5af246b6c86ff340410224 && ($this->initializer5af246b6c86ff340410224->__invoke($valueHolder5af246b6c86f2296584415, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5af246b6c86ff340410224) || 1) && $this->valueHolder5af246b6c86f2296584415 = $valueHolder5af246b6c86f2296584415;

        return $this->valueHolder5af246b6c86f2296584415->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5af246b6c86ff340410224 = $initializer;
    }
    ...
    {
        $this->initializer5af246b6c86ff340410224 && ($this->initializer5af246b6c86ff340410224->__invoke($valueHolder5af246b6c86f2296584415, $this, '__get', array('name' => $name), $this->initializer5af246b6c86ff340410224) || 1) && $this->valueHolder5af246b6c86f2296584415 = $valueHolder5af246b6c86f2296584415;

        if (isset(self::$publicProperties5af246b6c86cb059529957[$name])) {
            return $this->valueHolder5af246b6c86f2296584415->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5af246b6c86f2296584415;
    ...
    {
        $this->initializer5af246b6c86ff340410224 && ($this->initializer5af246b6c86ff340410224->__invoke($valueHolder5af246b6c86f2296584415, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5af246b6c86ff340410224) || 1) && $this->valueHolder5af246b6c86f2296584415 = $valueHolder5af246b6c86f2296584415;
    ...
    {
        $this->initializer5af246b6c86ff340410224 && ($this->initializer5af246b6c86ff340410224->__invoke($valueHolder5af246b6c86f2296584415, $this, '__isset', array('name' => $name), $this->initializer5af246b6c86ff340410224) || 1) && $this->valueHolder5af246b6c86f2296584415 = $valueHolder5af246b6c86f2296584415;
    ...
    {
        $this->initializer5af246b6c86ff340410224 && ($this->initializer5af246b6c86ff340410224->__invoke($valueHolder5af246b6c86f2296584415, $this, '__unset', array('name' => $name), $this->initializer5af246b6c86ff340410224) || 1) && $this->valueHolder5af246b6c86f2296584415 = $valueHolder5af246b6c86f2296584415;
    ...
    {
        $this->initializer5af246b6c86ff340410224 && ($this->initializer5af246b6c86ff340410224->__invoke($valueHolder5af246b6c86f2296584415, $this, '__clone', array(), $this->initializer5af246b6c86ff340410224) || 1) && $this->valueHolder5af246b6c86f2296584415 = $valueHolder5af246b6c86f2296584415;

        $this->valueHolder5af246b6c86f2296584415 = clone $this->valueHolder5af246b6c86f2296584415;
    }

    public function __sleep()
    {
        $this->initializer5af246b6c86ff340410224 && ($this->initializer5af246b6c86ff340410224->__invoke($valueHolder5af246b6c86f2296584415, $this, '__sleep', array(), $this->initializer5af246b6c86ff340410224) || 1) && $this->valueHolder5af246b6c86f2296584415 = $valueHolder5af246b6c86f2296584415;

        return array('valueHolder5af246b6c86f2296584415');
    }
    ...
    {
        return $this->initializer5af246b6c86ff340410224;
    }
    ...
    {
        return $this->initializer5af246b6c86ff340410224 && ($this->initializer5af246b6c86ff340410224->__invoke($valueHolder5af246b6c86f2296584415, $this, 'initializeProxy', array(), $this->initializer5af246b6c86ff340410224) || 1) && $this->valueHolder5af246b6c86f2296584415 = $valueHolder5af246b6c86f2296584415;
    }
    ...
    {
        return null !== $this->valueHolder5af246b6c86f2296584415;
    }
    ...
    {
        return $this->valueHolder5af246b6c86f2296584415;
    }
