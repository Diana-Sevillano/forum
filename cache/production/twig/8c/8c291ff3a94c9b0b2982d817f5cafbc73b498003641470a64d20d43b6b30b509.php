...
class __TwigTemplate_6e5079576832e27ca9cf97fb8b9a0d205098007baf4d0a46bac9309408e957ff extends Twig_Template
{
...
\t\t\t<dt><label for=\"board_announcements_enable\">";
        // line 35
        echo $this->env->getExtension('phpbb\template\twig\extension')->lang("BOARD_ANNOUNCEMENTS_GUESTS");
        echo $this->env->getExtension('phpbb\template\twig\extension')->lang("COLON");
        echo "</label></dt>
\t\t\t<dd>
